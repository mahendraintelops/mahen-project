...
import (
	...
	"github.com/mahendraintelops/mahen-project/test-service/config"
	restcontrollers "github.com/mahendraintelops/mahen-project/test-service/pkg/rest/server/controllers"
...
func main() {
	...
	testController, err := restcontrollers.NewTestController()
	if err != nil {
	...
	v1 := router.Group("/v1")
	{
		...
		v1.POST("/tests", testController.CreateTest)

		v1.GET("/tests", testController.ListTests)

		v1.GET("/tests/:id", testController.FetchTest)
